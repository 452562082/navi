...
var GrpcSwitcher = func(s nacicli.Servable, methodName string, resp http.ResponseWriter, req *http.Request) (rpcResponse interface{}, err error) {
	...
	case "{{$MethodName}}":
		...
		err = nacicli.BuildRequest(s, request, req)
		if err != nil {
			return nil, err
		}
	...
	nacicli.WithCallOptions(req, header, trailer, peer)
	return
}
`)
}
...
var thriftSwitcherFunc string = `// Code generated by nacicli. DO NOT EDIT.
package gen
...
var ThriftSwitcher = func(s nacicli.Servable, methodName string, resp http.ResponseWriter, req *http.Request) (serviceResponse interface{}, err error) {
	switch methodName {
{{range $i, $MethodName := .MethodNames}}
	case "{{$MethodName}}":{{if index $.NotEmptyParameters $i }}
		params, err := nacicli.BuildThriftRequest(s, &gen.{{$.ServiceName}}{{$MethodName}}Args{}, req, buildStructArg)
		if err != nil {
			return nil, err
		}{{end}}
...
func buildStructArg(s nacicli.Servable, typeName string, req *http.Request) (v reflect.Value, err error) {
	switch typeName {
{{range $i, $StructName := .StructNames}}
	case "{{$StructName}}":
		request := &gen.{{$StructName}}{ {{index $.StructFields $i}} }
		nacicli.BuildStruct(s, reflect.TypeOf(request).Elem(), reflect.ValueOf(request).Elem(), req)
