...
func (a *Agent) NewThriftAgenter() (t *thriftAgenter, err error) {
	...
	transport, err := thrift.NewTSocketTimeout(a.address, time.Duration(60)*time.Second)
	if err != nil {
		return nil, err
	}
...
func NewNaviServicePingResult() *ServicePingResult {
	return &ServicePingResult{}
}

var NaviServicePingResult_Success_DEFAULT string

func (p *ServicePingResult) GetSuccess() string {
	if !p.IsSetSuccess() {
		return NaviServicePingResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *ServicePingResult) IsSetSuccess() bool {
...
func (p *ServicePingResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *ServicePingResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *ServiceNameArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ServiceNameArgs) Write(oprot thrift.TProtocol) error {
...
func (p *ServiceNameArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ServiceNameArgs(%+v)", *p)
}

// Attributes:
//  - Success
type ServiceNameResult struct {
	Success *string `thrift:"success,0" db:"success" json:"success,omitempty"`
}

var NaviServiceServiceNameResult_Success_DEFAULT string

func (p *ServiceNameResult) GetSuccess() string {
	if !p.IsSetSuccess() {
		return NaviServiceServiceNameResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *ServiceNameResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ServiceNameResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ServiceNameResult) ReadField0(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return thrift.PrependError("error reading field 0: ", err)
	} else {
		p.Success = &v
...
func (p *ServiceNameResult) Write(oprot thrift.TProtocol) error {
...
func (p *ServiceNameResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRING, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *ServiceNameResult) String() string {
	if p == nil {
		return "<nil>"
	}
...
func (p *ServiceTypeResult) String() string {
	...
	return fmt.Sprintf("ServiceTypeResult(%+v)", *p)
}
